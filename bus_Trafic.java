...
public class bus_Trafic {
	...
	public static void main(String[] args) {
		...
		bus_Trafic.prix_avantPromo(ville_départ, prix,ville_arrivé);
	 ...
	 static  void prix_trajet(String[] u,double[] o,String[] p) {
		  ...
		  for(int i=0;i<u.length;i++) 
	       ...
	       static void prix_avantPromo(String[] u,double[] o,String[] p) {
		 
	    	    for(int i=0;i<u.length;i++) 
				  for(int j=1;j<p.length;j++) {
					  System.out.println ("le prix de trajet de "+u[i]+" à "+p[j]+" aprés ");
